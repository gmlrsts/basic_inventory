  ...
  <div class="row">
      <div class="col">
          <div class="mb-3">
              ...
              <input type="text" class="form-control form-control-lg " name="name" id="name"  autocomplete="name"  value="{{$item->name}}">
            </div>
      </div>
  ...
  <div class="row">
      <div class="col">
          <div class="mb-3">
              ...
              <input type="number" class="form-control form-control-lg" name="price" id="price" autocomplete="price"   value="{{$item->price}}"">
            </div>
      </div>
      ...
      <div class="col">
          <div class="mb-3">
              ...
              <input type="number" class="form-control form-control-lg " name="quantity" id="quantity" autocomplete="quantity"  value="{{$item->quantity}}"">
            </div>
      </div>
  </div>
